...
public class Game
{
    ...
    public Game()
    {
        ...
        Prisoner david = new David();
        Prisoner jugadorFito = new JugadorFito();
    ...
    public void roundRobin(int rounds)
    {
        ...
        for (int i = 0; i < prisoners.length; i++)
        {
            System.out.println(prisoners[i].getName() + " received " + scoreboard[i] + " points in total.");
        }
        System.out.println("");
    }
